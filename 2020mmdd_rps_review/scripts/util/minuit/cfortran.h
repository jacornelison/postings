/* cfortran.h  3.7 */          /* anonymous ftp@zebra.desy.de */
/* Burkhard Burow  burow@desy.de                 1990 - 1996. */
...
/* Kludge added 7/15/98 by JWF to eliminate GNU gcc compiler warnings of the 
   "defined but not used" flavor */
#ifndef ATTRIB_UNUSED
...
#if !(defined(mipsFortran)||defined(DECFortran)||defined(vmsFortran)||defined(CONVEXFortran)||defined(PowerStationFortran)||defined(AbsoftUNIXFortran))
...
#ifndef __CF__KnR
static char *c2fstrv(char* , char *, int, int ) ATTRIB_UNUSED;
...
#ifndef __CF__KnR
static char *f2cstrv(char *, char*, int, int) ATTRIB_UNUSED;
...
#ifndef __CF__KnR
static char *kill_trailing(char *, char) ATTRIB_UNUSED;
...
#ifndef __CF__KnR
static char *vkill_trailing(char*, int, int, char) ATTRIB_UNUSED;
...
#ifndef __CF__KnR
static int num_elem(char *, unsigned, int , int) ATTRIB_UNUSED;
...
#define     FLOAT_cfPU(A)   CFextern float FCALLSC_QUALIFIER   A
#else				   	                   
...
#define    DOUBLEVVVVV_cfSTR(N,T,A,B,C,D,E) _(CFARGS,N)(T,LOGICAL,A,B,C,D,E)
...
#define     FLOATVVVVV_cfSTR(N,T,A,B,C,D,E) _(CFARGS,N)(T,LOGICAL,A,B,C,D,E)
...
#define       INTVVVVV_cfSTR(N,T,A,B,C,D,E) _(CFARGS,N)(T,LOGICAL,A,B,C,D,E)
...
#define   LOGICALVVVVV_cfSTR(N,T,A,B,C,D,E) _(CFARGS,N)(T,LOGICAL,A,B,C,D,E)
...
#define      LONGVVVVV_cfSTR(N,T,A,B,C,D,E) _(CFARGS,N)(T,LOGICAL,A,B,C,D,E)
...
#define     SHORTVVVVV_cfSTR(N,T,A,B,C,D,E) _(CFARGS,N)(T,LOGICAL,A,B,C,D,E)
...
#define PROTOCCALLSFFUN14(T0,UN,LN,T1,T2,T3,T4,T5,T6,T7,T8,T9,TA,TB,TC,TD,TE)  \
 _(T0,_cfPU)(CFC_(UN,LN))(CF_NULL_PROTO); static _Icf(2,U,T0,CFFUN(UN),0)(     \
   ...
   ATTRIB_UNUSED;                         static _Icf(2,U,T0,CFFUN(UN),0)(     \
   CFARGT14FS(UCF,HCF,_Z,T1,T2,T3,T4,T5,T6,T7,T8,T9,TA,TB,TC,TD,TE) )          \
