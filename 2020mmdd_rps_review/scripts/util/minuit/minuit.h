/* CLP 980716 Changed arg 5&6 of MNPARM from PDOUBLE to DOUBLE to match
   Minuit manual (page 14). */
...
#define MNPARM(A1,A2,A3,A4,A5,A6,A7)  CCALLSFSUB7(MNPARM,mnparm,INT,STRING,DOUBLE,DOUBLE,DOUBLE,DOUBLE,PINT,A1,A2,A3,A4,A5,A6,A7)
