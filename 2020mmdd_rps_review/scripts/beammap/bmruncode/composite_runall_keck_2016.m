function composite_runall_keck_2016(winsize,makesingle,unrotplots,maskmaps,...
    maskplots,rotmaps,rotplots,compmaps,compplots,splitmaps)
% composite_runall_keck_2016(winsize,makesingle,unrotplots,maskmaps,...
...
compopt.plotdir = ['plots/keck_2016_compmaps_unrotated' compopt.suffix];
if unrotplots
...
compopt.plotdir = ['plots/keck_2016_compmaps_masked' compopt.suffix];
...
if compplots
  compopt.coord = 'dk0';
  compopt.plotdir = ['plots/keck_2016_composites' ...
                   compopt.suffix '_dk0'];
  compopt.compositefile = ['ffbm_2016_all_onlycommonab' ...
                    compopt.suffix '_dk0'];
  compopt.componentfile = ['ffbm_2016_allcomp_rotated' ...
