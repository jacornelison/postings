%Converted from Cynthia's C code "gal2cel_qu.c" in bicep_point.c
%JET 20111011
%
%Input: (qi, ui) = input maps
%       (l, b)= coordinate of input maps in gal

%Ouput: (qo, uo) = output maps
%       (ra,dec)    = output coord in cel

function [ra, dec, qo, uo]=gal2cel_qu(l,b, qi,ui)
