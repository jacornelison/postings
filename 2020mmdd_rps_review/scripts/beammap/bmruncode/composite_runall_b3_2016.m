function composite_runall_b3_2016(winsize,makesingle,unrotplots,maskmaps,...
    maskplots,rotmaps,rotplots,compmaps,compplots,splitmaps)
% composite_runall_b3_2016(winsize,makesingle,unrotplots,maskmaps,...
...
switch winsize
  case 2
    compopt.suffix = '';
    compopt.componentfile = 'ffbm_2016_allcomp_2deg';
  case 8
    compopt.suffix = '_8deg';
end

% Gather all windowed map files from beammaps/maps into a single file
%  -> beammaps/maps_component/ffbm_2016_allcomp.mat
if makesingle
...
compopt.plotdir = ['plots/b3_2016_compmaps_unrotated' compopt.suffix];
if unrotplots
...
%   beammaps/maps_component/ffbm_2016_allcomp.mat ->
%   beammaps/maps_masked/ffbm_2016_allcomp_masked.mat
if maskmaps
...
compopt.plotdir = ['plots/b3_2016_compmaps_masked' compopt.suffix];
compopt.componentdir = 'beammaps/maps_masked';
compopt.componentfile = ['ffbm_2016_allcomp_masked' compopt.suffix];
compopt.plotfitxy = 0;
if maskplots
  ffbm_plotCompMaps(compopt);
end
...
%   beammaps/maps_masked/ffbm_2016_allcomp_masked.mat ->
%   beammaps/maps_rotated/ffbm_2016_allcomp_rotated.mat
if rotmaps
  % First rotate to dk0
  compopt.coord = 'dk0';
  ffbm_rotatemaps(compopt);
  % Saves to ffbm_2016_allcomp_rotated_8deg_dk0
  compopt.coord = 'xpyp';
  ffbm_rotatemaps(compopt);
  % Saves to ffbm_2016_allcomp_rotated_8deg_xpyp
end
...
if rotplots
  compopt.plotdir = ['plots/keck_2016_compmaps_rotated' ...
                     compopt.suffix '_dk0'];
  compopt.componentfile = ['ffbm_2016_allcomp_rotated' ...
                      compopt.suffix '_dk0'];
  compopt.coord = 'dk0';
  ffbm_plotCompMaps(compopt);
  compopt.plotdir = ['plots/keck_2016_compmaps_rotated' ...
...
%   beammaps/maps_rotated/ffbm_2016_allcomp_rotated.mat ->
%   beammaps/maps_composite/ffbm_2016_all_onlycommonab.mat
compopt.onlycommon_ab = 1;
compopt.radtozero = winsize;
if compmaps
  % First composite dk0
  compopt.coord = 'dk0';
  compopt.rotatedfile = ['ffbm_2016_allcomp_rotated' ...
                      compopt.suffix '_dk0'];
  compopt.compositefile = ['ffbm_2016_all_onlycommonab' ...
                      compopt.suffix '_dk0'];
...
compopt.onlychflag = 0; % Until we have channel flags
if compplots
  compopt.coord = 'dk0';
  compopt.plotdir = ['plots/b3_2016_composites' ...
                   compopt.suffix '_dk0'];
  compopt.compositefile = ['ffbm_2016_all_onlycommonab' ...
                    compopt.suffix '_dk0'];
  compopt.componentfile = ['ffbm_2016_allcomp_rotated' ...
