function [cbin, xbin, ybin, STO, phasebin] = moon_illumination(mpos,spos,ang_diam,np_ang,ppd)
...
colormap default
grid on
scatter(acosd(local_phase),Mlat,15,Tmap,'filled')

fig = figure(4);
clf; hold on;
ind = isnan(Tmap);
scatter(Mpoints(1,ind),Mpoints(2,ind),14,acosd(local_phase(ind)),'filled')
