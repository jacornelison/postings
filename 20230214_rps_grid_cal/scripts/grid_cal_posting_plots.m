...
% days = [59583,59584,59587,59590]; % 4th/5th for sunny and 8th/11th for cloudy
% ind = ismember(floor(lj_data.time),days);
% ljd = structcut(lj_data,ind);
% save(fullfile(datadir,'tilt_data_four_day.mat'),'ljd')

%%
load(fullfile(datadir,'tilt_data_four_day.mat'))

days = [59583,59584,59587,59590];
