function composite_runall_keck_2014(winsize,makesingle,unrotplots,maskmaps,...
    maskplots,rotmaps,rotplots,compmaps,compplots,splitmaps)
% composite_runall_keck_2014(winsize,makesingle,unrotplots,maskmaps,...
...
switch winsize
  case 2
    compopt.suffix = '';
    compopt.componentfile = 'ffbm_2014_allcomp_2deg';
  case 8
...
compopt.plotdir = ['plots/keck_2014_compmaps_unrotated' compopt.suffix];
if unrotplots
...
compopt.plotdir = ['plots/keck_2014_compmaps_masked' compopt.suffix];
compopt.componentdir = 'beammaps/maps_masked';
compopt.componentfile = ['ffbm_2014_allcomp_masked' compopt.suffix];
compopt.plotfitxy = 0;
if maskplots
  ffbm_plotCompMaps(compopt);
end
...
if rotmaps
  ...
  % Saves to ffbm_2014_allcomp_rotated_8deg_dk0
  compopt.coord = 'xpyp';
  ffbm_rotatemaps(compopt);
  % Saves to ffbm_2014_allcomp_rotated_8deg_xpyp
end
...
if compmaps
  % First composite dk0
  compopt.coord = 'dk0';
  compopt.rotatedfile = ['ffbm_2014_allcomp_rotated' ...
                      compopt.suffix '_dk0'];
